...
%     end
    ...
    if mod(k-1,beishu)==0
        ...
        if (pre_show(kkk)>45 && pre_show(kkk)<135)||(pre_show(kkk)>-135 &&...
                pre_show(kkk)<-45), flag_sgn=-1;
        else, flag_sgn=1;
        end
...
%                 fqs(kkk-1:kkk));
    ...
    F1(k+1)=1/GHox.xx* flag_sgn* fps(kkk)*sin(phi(k+1)+pi/2);
